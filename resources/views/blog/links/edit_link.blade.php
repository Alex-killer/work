<div class="modal fade" id="editlink-{{ $link->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
     tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('blog.link.update', $link->id) }}" method="POST">
                @csrf
                @method('PATCH')
